...
public class SpOrderHisNew {
	...
	public String getGrnPer() {
		return grnPer;
	}

	public void setGrnPer(String grnPer) {
		this.grnPer = grnPer;
	}
	...
	public String toString() {
		return "SpOrderHisNew [spOrderNo=" + spOrderNo + ", frCode=" + frCode + ", spType=" + spType + ", spId=" + spId
				...
				+ spAddRate + ", spGrand=" + spGrand + ", isBillGenerated=" + isBillGenerated + ", menuTitle="
				+ menuTitle + ", grnPer=" + grnPer + ", discPer=" + discPer + "]";
	}
