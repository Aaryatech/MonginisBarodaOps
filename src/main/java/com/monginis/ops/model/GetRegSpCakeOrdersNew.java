...
public class GetRegSpCakeOrdersNew {
...
private String menuTitle;
	...
	public String toString() {
		return "GetRegSpCakeOrdersNew [rspId=" + rspId + ", frName=" + frName + ", frMob=" + frMob + ", itemName="
				...
				+ ", rspCustMobileNo=" + rspCustMobileNo + ", menuTitle=" + menuTitle + ", grnPer=" + grnPer
				+ ", discPer=" + discPer + "]";
	}
