			...
			<div class="sidebarright">
				...
				<c:if test="${isFound==true}">
					<div class="alert alert-success">
						<strong>Success!</strong> Your Order Saved Successfully,Thank
						you!!
					</div>
				</c:if>
				...
				<div class="ordercake">
					...
					<div class="left">
						...
						<div class="fullform">
							...
							<div class="cackright">
								<span class="cakename">${spName}</span>
							</div>
						</div>
						...
						<div class="fullform">
							...
							<div class="cackright">
								<fmt:parseDate value="${specialCake.spEstDeliDate}"
									pattern="yyyy-MM-dd" var="spEstDeliDateFmt" />
								<fmt:formatDate value="${spEstDeliDateFmt}"
									var="formatedEarDelDate" pattern="dd-MM-yyyy" />
								${formatedEarDelDate}
							</div>
						</div>
		...
		<c:when test="${spType=='1'}">
				...
				Chocolate
						...
						<div class="fullform">
							...
							<div class="cackright">${flavourName}</div>
						</div>

						<div class="fullform">
							<div class="cackleft">Weight</div>
							<div class="cackright">${specialCake.spSelectedWeight} Kg</div>
						</div>
       ...
       <img src="${PHOTO_URL}${specialCake.orderPhoto2}"alt="image"/>
                   ...
                   ${specialCake.spInstructions}
						...
						<div class="fullform">
							...
							<div class="cackright">
								<fmt:parseDate value="${specialCake.spDeliveryDate}"
									pattern="yyyy-MM-dd" var="spDeliveryDateFmt" />
								<fmt:formatDate value="${spDeliveryDateFmt}"
									var="formatedDelDate" pattern="dd-MM-yyyy" />
								${formatedDelDate}
						...
						<div class="fullform">
							...
							<div class="cackright">
								<c:choose>
									...
									<c:otherwise>
										<fmt:parseDate value="${specialCake.spCustDob}"
											pattern="yyyy-MM-dd" var="spCustDobFmt" />
										<fmt:formatDate value="${spCustDobFmt}" var="spCustDobFormat"
											pattern="dd-MM-yyyy" />
	              ${spCustDobFormat}
            </c:otherwise>
								</c:choose>
						...
						<div class="fullform">
							...
							<div class="cackright">${specialCake.spCustMobNo}</div>
						</div>
		...
		<div class="cackright">
		 ${specialCake.spBookForNumber} 
					...
					<div class="right">
						<div class="priceBox">
							<h2 class="inrbox" style="font-size: 20px;">
								INR - <span id="pro_grand_totla_1" style="font-size: 20px;">
									${specialCake.spGrandTotal}</span>
							</h2>
...
<div class="messages messagesSuccess">success message </div>-->
			...
			<a
				href="${pageContext.request.contextPath}/showSpCakeOrder/${globalIndex}"><h1><<
					Back</h1></a> <br /> <a
				href="${pageContext.request.contextPath}/showSpCakeOrderPDF"
				target="_blank"><h1>PDF</h1></a>
			<!--rightSidebar-->
