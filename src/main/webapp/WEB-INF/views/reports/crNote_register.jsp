							...
							<table id="table_grid1" class="main-table" border="1">
								<thead>
									<tr class="bgpink">
										...
										<th style="text-align: center; white-space: nowrap;">CRN Amt</th>
									</tr>
