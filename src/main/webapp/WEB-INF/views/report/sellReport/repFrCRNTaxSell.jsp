...
<c:url var="getBillwiseTaxSellReport" value="/getCRNBillTaxSellReport" />
	...
	<div class="fullGrid center">
		...
		<div class="wrapperIn2">
			...
			<div class="sidebarright">
				...
				<div class="row">
					<div class="col-md-12">
						<h2 class="pageTitle">View Credit Note Tax Bill wise Report</h2>
					</div>
				</div>
								...
								<table id="table_grid1" class="main-table" border="1">
									<thead>
										<tr class="bgpink">
											...
											<th class="col-md-2" align="center">CRN No.</th>
											<th class="col-md-1" align="center">Bill Date</th>
											<th class="col-md-1" align="center">CRN Date</th>
											<th class="col-md-1" align="center">CRN Amt</th>
