			...
			<%-- <c:forEach items="${sessionScope.empModule}" var="list" varStatus="count">	
				...
				<c:if test="${moduleId==1}">
					...
					<li style="border: 1px; border-bottom: 1px solid #c9206c;"><a
						href="${pageContext.request.contextPath}/newPos/0"><div
								class="img">
								<img
...
<div class="row">
					<li class="small-box">
						...
						<a href="${pageContext.request.contextPath}/itemWiseHsnReport"><i class="fa fa-file-text-o icon"></i> Item Wise HSN Report(Sale) </a>
						<a href="${pageContext.request.contextPath}/viewCrnTaxSellBill"><i class="fa fa-file-text-o icon"></i> Tax Report Summary(Credit Note)</a>
						<a href="${pageContext.request.contextPath}/viewFrCRNTaxSellBill"><i class="fa fa-file-text-o icon"></i> Bill Report(Credit Note)</a>
						</div>
