...
<div class="wrapper">
 ...
 <input type="hidden" value="${gstType}" name="type" id="type"/>
	...
	<c:choose>
												...
												<td style="text-align: left; white-space: nowrap;"><c:out value="${GVNstatus}"></c:out></td>
												<c:choose>
													<c:when test="${grnList.isCreditNote==1}">
			...
			//if (isValid) {
				...
				$.getJSON('${getGrnList}', {
					...
					$.each(data, function(key, grndata) {
						...
						tr.append($('<td style="text-align: left; white-space: nowrap;"></td>').html(grndata.grnGvnStatusStr));
						tr.append($('<td style="text-align: right; white-space: nowrap;"></td>').html(credited));
						...
						if(grndata.isCreditNote==1)
							{
						tr.append($('<td style="text-align: left;" ><a href="#" class="action_btn" onclick="getGvnDetail('+grndata.grnGvnHeaderId+')"><abbr title="Detail"><i class="fa fa-list"></i></abbr></a>&nbsp; <a href="#" class="action_btn" onclick="genPdf('+grndata.grnGvnHeaderId+')"><i class="fa fa-file-pdf-o" style="color:red"></i></a>&nbsp; <a href="#" class="action_btn" onclick="genCrnPdf('+grndata.grnGvnHeaderId+')">CRN</a></td>'));
							}else{
								tr.append($('<td style="text-align: center;" ><a href="#" class="action_btn" onclick="getGvnDetail('+grndata.grnGvnHeaderId+')"><abbr title="Detail"><i class="fa fa-list"></i></abbr></a>&nbsp; <a href="#" class="action_btn" onclick="genPdf('+grndata.grnGvnHeaderId+')"><i class="fa fa-file-pdf-o" style="color:red"></i></a></td>'));
						    }
